...
//				execOptions,
//				connOptions
//		)).name("Create sales_transactions table sink");
//
//		transactionStream.addSink(JdbcSink.sink(
//				"INSERT INTO sales_transactions(transaction_id, product_id, product_name, product_category, product_price, " +
...
//				execOptions,
//				connOptions
//		)).name("Insert into sales_transactions table sink");
